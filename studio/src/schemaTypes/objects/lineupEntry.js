...
export const lineupEntry = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'reference',
            to: [{ type: 'artist' }],
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.type) !== 'resident',
            validation: (Rule) => Rule.custom((val, ctx) => {
                var _a;
                if (((_a = ctx.parent) === null || _a === void 0 ? void 0 : _a.type) === 'resident' && !val)
                    return 'Pick an artist';
                return true;
            }),
        }),
        ...
        defineField({
            ...
            title: 'DJ Name',
            type: 'string',
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.type) !== 'nonresident',
            validation: (Rule) => Rule.custom((val, ctx) => {
                var _a;
                if (((_a = ctx.parent) === null || _a === void 0 ? void 0 : _a.type) === 'nonresident' && !val)
                    return 'Enter a DJ name';
                return true;
            }),
        }),
        defineField({
        ...
        defineField({
            ...
            validation: (Rule) => Rule.custom((val, ctx) => {
                const parent = ctx.parent;
                const startsAt = parent === null || parent === void 0 ? void 0 : parent.setStartsAt;
    ...
    preview: {
        ...
        prepare({ type, artistName, name, note, orderIndex, media, country, setStartsAt, setEndsAt }) {
            ...
            const parts = [typeLabel, country, timeStr, note, `#${orderIndex !== null && orderIndex !== void 0 ? orderIndex : 0}`].filter(Boolean);
            return {
                title: title || '—',
                subtitle: parts.join(' · '),
