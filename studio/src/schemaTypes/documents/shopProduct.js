...
const localizedStringRequired = (value) => (value === null || value === void 0 ? void 0 : value.en) || (value === null || value === void 0 ? void 0 : value.cn) ? true : 'Provide at least one title';
export const shopProduct = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'slug',
            options: {
                source: (doc) => { var _a, _b; return ((_a = doc === null || doc === void 0 ? void 0 : doc.name) === null || _a === void 0 ? void 0 : _a.en) || ((_b = doc === null || doc === void 0 ? void 0 : doc.name) === null || _b === void 0 ? void 0 : _b.cn) || ''; },
                maxLength: 96,
