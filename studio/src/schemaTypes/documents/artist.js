...
export const artist = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'string',
            description: 'Optional. Leave empty to rotate automatically by artist index. Custom SVG titles should use --artist-title-main and --artist-title-gradient CSS variables.',
            options: {
                list: [
        ...
        defineField({
            ...
            validation: (rule) => rule
                .uri({ scheme: ['https'] })
                .custom((value) => !value || String(value).includes('soundcloud.com') ? true : 'Use a SoundCloud set URL.'),
        }),
        // defineField({
        //   name: 'instagram',
        //   title: 'Instagram',
        ...
        defineField({
            ...
            validation: (Rule) => Rule.required().error('You must provide SVG markup to publish this artist.'),
        }),
    ],
    preview: {
        select: {
